const ownerNumber = ["5575998868032@s.whatsapp.net"] 
// mude somente o numero e não tire o @s.whatsapp.net

const OriginalOwner = '5575998868032' 
...
const apikeyimgbb = '824babd1991314061a3ea5ee1eb702b5'
...
+ 'FN:Meu criador^~^\n' 
+ 'ORG:K͢Iℜ͢A͢么;\n' 
+ 'TEL;type=CELL;type=VOICE;waid=5575998868032:+55 75 99886-8032\n' 
+ 'END:VCARD'
